...
export default function Header({ searchBar }) {
    ...
    useGSAP(
        () => {
            ...
            const ctx =gsap.context(()=>{if (modal) {
    ...
    return (
        <>
            <header className="fixed flex justify-between w-full md:gap-56 top-4.5 px-2 md:px-0 z-100  ">
                <div className={searchBar ? "md:w-[65%] bg-white text-black flex items-center justify-between px-10 md:py-4 py-2 rounded shadow-xl md:ml-18" : "w-[47%] bg-white text-black flex items-center justify-between px-10 md:py-4 py-2 rounded shadow-xl md:ml-18"}>
                ...
                <div className=" bg-white text-black px-5 md:mr-20 md:px-5 md:py-4 md:w-[12%] flex justify-center items-center rounded-[40px] md:gap-6 gap-2 shadow-xl">
                   <Link to={"/login"}><h1 className="hidden md:block text-l font-bold hover:text-fuchsia-700 cursor-pointer ">Log In</h1></Link>
